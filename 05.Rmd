...
fit of an OLS model. Unlike with straight line fits where we can just connect the dots, we need
to draw the "true" curve with a sufficient number of points to get as close as possible to the

...
some of the variables that should be of type numeric were read in as a strings due to the presence
of the string `"NULL"` (note that the string `"NULL"` is not the same as `NA`).

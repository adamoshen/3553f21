...
We are interested in performing stepwise selection using `body_mass` as the response. We commence
the model building process by including the variable that is most correlated to `body_mass`.
